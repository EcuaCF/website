...
export default function Clients() {
  ...
  return (
    ...
    >
      ...
      {/* Carousel */}
      <SlideUp>
        <div className="relative z-10 w-full flex items-center justify-center py-16 h-70">
          {/* Left Arrow */}
          
            <button
              onClick={handlePrev}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/70 hover:bg-white/40 cursor-pointer rounded-full ml-15"
            >
              <IconArrowLeft className="w-6 h-6 text-black" />
            </button>
            ...
            <button
              onClick={handleNext}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white/70 hover:bg-white/40 cursor-pointer rounded-full mr-15"
            >
              <IconArrowRight className="w-6 h-6 text-black" />
            </button>
        </div>
      </SlideUp>
    </div>
